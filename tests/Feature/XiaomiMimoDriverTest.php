...
class XiaomiMimoDriverTest extends TestCase
{
    public function testChat(): void
    {
        ...
        $this->assertEquals('Hello from Xiaomi MiMo', $response->content);
        $this->assertEquals('mimo-v2.5-pro', $response->model);
        $this->assertEquals('xiaomi-mimo', $response->driver);
    }
}